...
export default class Social extends Component {
  constructor(props) {
    ...
    this.state = {
      tweetLink: `https://twitter.com/share?url=${escape(window.location.origin)}${escape('/#')}${escape(
        props.url,
      )}&text=${escape(getDescription(props.description).title)}`,
      tweetImg: tweet,
      openImg: open,
    };
    ...
    return (
      <div className="post-footer">
        <div className="micro-menu">
          <Link
            to={this.props.url}
            className="micro-button micro-button-feed no-underline"
            rel="noopener noreferrer"
            onMouseEnter={this.openToggle}
            onMouseLeave={this.openToggle}
          >
        ...
        <div className="micro-menu">
          <a
            ...
            onMouseEnter={this.tweetToggle}
            onMouseLeave={this.tweetToggle}
          >
