...
const Layout = props => {
  ...
  if (dao) {
    ...
    description =
      i18n.t('meta-period', { period }).charAt(0).toUpperCase() + i18n.t('meta-period', { period }).slice(1);
  } else if (proposal) {
    proposalId = proposal;
  ...
  if (props.mobileMenu) {
    return <Burger address={renderAddress} view={view} proposalId={proposalId} param={param} />;
  }
